...
import pox.openflow.PMdatabase
...
def _pre_startup ():
  ...
  if _options.enable_openflow:
    ...
    pox.openflow.PMdatabase.launch() # added by lsr for pof
    pox.openflow.PofManager.launch() # added by lsr for pof
