...
classfier_table = {
	...
	'classfier_core': [ 0xfd, of.OF_EM_TABLE, 128, [47] ],
}
...
ins = {('first table', 0) : [ ['gototable', [1]] ],
	...
	('classfier_core', 0): [ ['applyaction', [ ['output', [ST_CORE]] ]] ],
...
tslot_config = {'flow1':[1,1,20], 'flow2':[2,3,30], 'flow3':[3,5,20], 'flow4':[4,7,20]}
