...
#######################################################################
#setup USTC/NC/IOA flow table when cooperation_test
#######################################################################
...
def cooper_test_NC(event):    
  ...
  tempmatchx.offset=0
  tempmatchx.length=48
  tempmatchx.set_value("bc305ba4e124")  #FIXME:USTC PC MAC
  tempmatchx.set_mask("ffffffffffff")
  msg.matchx.append(tempmatchx)
  ...
  tempmatchx.offset=0
  tempmatchx.length=48
  tempmatchx.set_value("6cf0498cd47b")  #FIXME: SXS PC MAC
  tempmatchx.set_mask("ffffffffffff")
  msg.matchx.append(tempmatchx)
  ...
  tempmatchx.offset=0
  tempmatchx.length=48
  tempmatchx.set_value("643e8c369927")  #FIXME:Network Center Switch MAC
  tempmatchx.set_mask("ffffffffffff")
  msg.matchx.append(tempmatchx)
  ...
  tempmatchx.offset=0
  tempmatchx.length=48
  tempmatchx.set_value("90e2ba2a22ca")  #FIXME:Network Center PC MAC
  tempmatchx.set_mask("ffffffffffff")
  msg.matchx.append(tempmatchx)
  ...
  tempins=of.ofp_instruction_writemetadata()
  tempins.metaDataOffset=32
  tempins.set_value('70e2ba2a22cb')   #FIXME: Network Center GateWay MAC
  tempins.writeLength = 48
  msg.instruction.append(tempins)
  ...
  tempins=of.ofp_instruction_writemetadata()
  tempins.metaDataOffset=80
  tempins.set_value('643e8c369927')   #FIXME:Network Center switch MAC
  tempins.writeLength = 48
  msg.instruction.append(tempins)
...
def cooper_test_IOA(event):    
  ...
  tempmatchx.offset=0
  tempmatchx.length=48
  tempmatchx.set_value("643e8c3dc61f")  #FIXME:SXS Switch MAC
  tempmatchx.set_mask("ffffffffffff")
  msg.matchx.append(tempmatchx)
  ...
  tempins=of.ofp_instruction_writemetadata()
  tempins.metaDataOffset=240
  tempins.set_value('c0a82f49')    #SXS Switch IP
  tempins.writeLength = 32
  msg.instruction.append(tempins)    
  ...
  tempins=of.ofp_instruction_writemetadata()
  tempins.metaDataOffset=32
  tempins.set_value('70f96d594742')   #FIXME:SXS GateWay MAC
  tempins.writeLength = 48
  msg.instruction.append(tempins)
  ...
  tempins=of.ofp_instruction_writemetadata()
  tempins.metaDataOffset=80
  tempins.set_value('643e8c3dc61f')   #FIXME:SXS switch MAC
  tempins.writeLength = 48
  msg.instruction.append(tempins)
...
def _handle_ConnectionUp (event):
    '''
    if event.connection.dpid == 2352388391:
       print '-----NC-------'
       cooper_test_NC(event)  
    '''
