...
def test_for_ipv6(event):    
  ...
  tempins.value=[96,0,0,0,0,0,17,32]   #should be a string, need to modify
  tempins.writeLength = 64
  msg.instruction.append(tempins)
  ...
  tempins.value=[255,255,255,255,255,255,255,255,0,0,0,0,0,0,0,1]  #should be a string, need to modify
  tempins.writeLength = 128
  msg.instruction.append(tempins)
  ...
  tempins.value=[255,255,255,255,255,255,255,255,0,0,0,0,0,0,0,2]   #should be a string, need to modify
  tempins.writeLength = 128
  msg.instruction.append(tempins)
