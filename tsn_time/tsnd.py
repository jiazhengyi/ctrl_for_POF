...
def add_tsn_switch(event):
        msg = table.add_classfier_table('classifier3')
        event.connection.send(msg)

        msg = table.add_classfier_entry('classifier3', 2)
        event.connection.send(msg)
...
def _handle_ConnectionUp(event):
        ...
        if (event.dpid == 2):
            msg = conf.add_TSN_config_multi_all_add_1(1,'0xffffffffff00',0x2,'1|2|3|4|5|6|7|8|9',3)
            event.connection.send(msg)
